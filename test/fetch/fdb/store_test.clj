...
(deftest store-test
  ...
  (let [k         "dummy"
    ...
    (testing "can figure out latest revision of a key"
      (is (= {:mod-revision rev1 :lease l1 :key k :value v1 :create-revision 0}
    ...
    (let [[rev2 ok?] (store/update-at-revision *store* k rev1 (str->ba v2) l2)]
      ...
      (testing "can retrieve new version"
        (is (= {:mod-revision rev2 :lease l2 :key k :value v2 :create-revision 0}
